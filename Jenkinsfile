node {
    ...
    stage('Build image') {
        ...
        app = docker.build("004959158725.dkr.ecr.us-east-1.amazonaws.com/demoapp")
    }
    ...
    stage('Push image') {
        ...
        docker.withRegistry('https://004959158725.dkr.ecr.us-east-1.amazonaws.com', 'ecr:us-east-1:aws_ecr')    {
